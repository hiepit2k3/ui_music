...
const roomId = ref("room1"); // ID phòng hiện tại
    ...
    <div class="bg-white p-6 rounded-xl shadow-xl w-full">
      <div class="flex flex-wrap gap-4 w-full">
        ...
        <div
          ...
          <div class="relative">
            ...
            />
            <svg
              class="absolute top-3 right-3 text-gray-500 w-5 h-5"
              @click="searchMusic"
              stroke="currentColor"
              stroke-width="1.5"
              viewBox="0 0 24 24"
      ...
      <div class="mt-6 bg-gradient-to-b from-pink-200 via-pink-100 to-purple-100 rounded-lg shadow-md">
        <div
          ...
          <div class="rounded-lg overflow-hidden">
            <img
              src="../assets/image/background_music.jpg"
              alt="Album art"
      ...
      <div class="mt-6 bg-pink-200 p-6 rounded-lg shadow-md">
        ...
        <div class="flex justify-center flex-wrap gap-4">
          <CardNumberRoom
            v-for="(number, index) in musicState.numbers"
            :key="index"
