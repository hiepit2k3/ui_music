<template>
    <div class="relative flex flex-col mt-8 p-4 rounded-md text-black bg-white">
        ...
        <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0">
            <div
                ...
                <div class="flex flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
                    <div class="max-w-full px-1 ml-auto flex-0">
                        <a
                            ...
                            <svg xmlns:xlink="http://www.w3.org/1999/xlink32" xmlns="http://www.w3.org/2000/svg"
                                version="1.1" viewBox="0 0 64 64" height="32px" width="24px">
                    ...
                    <div class="max-w-full px-1 mr-auto flex-0">
                        <a
                            class="inline-block w-full px-6 py-3 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:scale-102 leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:bg-transparent hover:opacity-75">
                            <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
                                version="1.1" viewBox="0 0 64 64" height="32px" width="24px">
        ...
        <div class="relative w-full max-w-full px-3 mt-2 text-center shrink-0">
            <p class="text-gray-600 cursor-text text-sm leading-[140%] font-normal mb-2">or</p>
        </div>
        <form class="flex flex-col gap-4">
            <div class="">
                <div class="row">
                    ...
                    <div class="block relative mb-4">
                        <label for="username"
                            class="block text-gray-600 cursor-text text-sm leading-[140%] font-normal mb-2">User
                            Name</label>
                    ...
                    <InputPassword v-model="confirm_password" labelname="Confirm Password" />
                </div>
            </div>

            <button type="submit"
                class="bg-pink-600 font-medium w-max m-auto px-6 py-2 rounded text-white text-sm font-normal">Register</button>

        </form>
        <div class="text-sm text-center mt-[1.6rem]">Have an account yet? <a class="text-sm text-[#7747ff]"
                href="#">Sign in now!</a>
        </div>
    </div>
</template>
...
import InputPassword from '@/components/input_component/InputPassword.vue';
